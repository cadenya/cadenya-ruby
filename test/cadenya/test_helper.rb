...
class Cadenya::Test::SingletonClient < Cadenya::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Cadenya::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Cadenya::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @cadenya = Cadenya::Test::SingletonClient.instance
  end
