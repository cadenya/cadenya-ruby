...
class Cadenya::Test::PrimitiveModelTest < Minitest::Test
  A = Cadenya::Internal::Type::ArrayOf[-> { Integer }]
  H = Cadenya::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Cadenya::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Cadenya::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Cadenya::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Cadenya::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Cadenya::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Cadenya::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Cadenya::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Cadenya::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Cadenya::Internal::Type::Boolean, true] => true,
      [Cadenya::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Cadenya::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Cadenya::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Cadenya::Internal::Type::Converter.new_coerce_state
      Cadenya::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Cadenya::Internal::Type::Converter.dump(target, input, state: state)
...
class Cadenya::Test::EnumModelTest < Minitest::Test
  class E0
    include Cadenya::Internal::Type::Enum
...
class Cadenya::Test::CollectionModelTest < Minitest::Test
  A1 = Cadenya::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Cadenya::Internal::Type::HashOf[Integer]

  A2 = Cadenya::Internal::Type::ArrayOf[H1]
  H2 = Cadenya::Internal::Type::HashOf[-> { A1 }]

  A3 = Cadenya::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Cadenya::Internal::Type::HashOf[Integer, nil?: true]
...
class Cadenya::Test::BaseModelTest < Minitest::Test
  class M1 < Cadenya::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Cadenya::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Cadenya::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Cadenya::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Cadenya::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Cadenya::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Cadenya::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Cadenya::Errors::ConversionError => e
...
class Cadenya::Test::UnionTest < Minitest::Test
  class U0
    include Cadenya::Internal::Type::Union
  ...
  class M2 < Cadenya::Internal::Type::BaseModel
  ...
  class M4 < Cadenya::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Cadenya::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Cadenya::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Cadenya::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Cadenya::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Cadenya::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Cadenya::Internal::Type::Unknown, Cadenya::Internal::Type::Unknown] => true,
      [Cadenya::Internal::Type::Boolean, Cadenya::Internal::Type::Boolean] => true,
      [Cadenya::Internal::Type::Unknown, Cadenya::Internal::Type::Boolean] => false,
...
class Cadenya::Test::MetaInfoTest < Minitest::Test
  A1 = Cadenya::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Cadenya::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
