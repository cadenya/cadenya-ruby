...
class CadenyaTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:get, "http://localhost/v1/account").to_return_json(status: 500, body: {})
  ...
  def test_client_given_request_default_retry_attempts
    ...
    cadenya = Cadenya::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Cadenya::Errors::InternalServerError) do
      cadenya.account.retrieve(request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Cadenya::Errors::InternalServerError) do
      cadenya.account.retrieve(request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:get, "http://localhost/v1/account").to_return_json(
      status: 500,
      headers: {"retry-after" => "1.3"},
      body: {}
    )

    cadenya = Cadenya::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Cadenya::Errors::APIConnectionError) do
      cadenya.account.retrieve(request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: Cadenya::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Cadenya::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(Cadenya::Errors::APIConnectionError) do
      cadenya.account.retrieve(request_options: {extra_headers: {"authorization" => "Bearer xyz"}})
    end
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Cadenya::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:get, "http://localhost/v1/account").to_return_json(status: 200, body: {})
