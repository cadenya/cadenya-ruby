...
module Cadenya
  module Models
    class UnsafeUnwrapWebhookEvent < Cadenya::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Cadenya::UnsafeUnwrapWebhookEvent, Cadenya::Internal::AnyHash)
        end

      # The webhook data payload with flat top-level keys for agent, variation,
      # objective, and event.
      sig { returns(Cadenya::UnsafeUnwrapWebhookEvent::Data) }
      attr_reader :data

      sig { params(data: Cadenya::UnsafeUnwrapWebhookEvent::Data::OrHash).void }
      attr_writer :data
      ...
      sig do
        params(
          data: Cadenya::UnsafeUnwrapWebhookEvent::Data::OrHash,
          timestamp: Time,
          type: String
      ...
      sig do
        override.returns(
          {
            data: Cadenya::UnsafeUnwrapWebhookEvent::Data,
            timestamp: Time,
            type: String
          }
        )
      ...
      class Data < Cadenya::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cadenya::UnsafeUnwrapWebhookEvent::Data,
        ...
        sig { returns(Cadenya::UnsafeUnwrapWebhookEvent::Data::ObjectiveEvent) }
        attr_reader :objective_event

        sig do
          params(
            objective_event:
              Cadenya::UnsafeUnwrapWebhookEvent::Data::ObjectiveEvent::OrHash
          ).void
        end
