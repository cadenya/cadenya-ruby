...
module Cadenya
  module Models
    class ToolSetAdapterOpenAPIUploadID < Cadenya::Internal::Type::BaseModel
      ...
      sig { returns(Cadenya::ToolSetAdapterOpenAPIUploadID::Type::OrSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          type: Cadenya::ToolSetAdapterOpenAPIUploadID::Type::OrSymbol,
          upload_id: String,
          base_url: String,
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Cadenya::ToolSetAdapterOpenAPIUploadID::Type)
          end
        ...
        UPLOAD_ID =
          T.let(
            :uploadId,
            Cadenya::ToolSetAdapterOpenAPIUploadID::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Cadenya::ToolSetAdapterOpenAPIUploadID::Type::TaggedSymbol]
          )
        end
        def self.values
        end
