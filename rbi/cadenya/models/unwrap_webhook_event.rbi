  ...
  module Models
    class UnwrapWebhookEvent < Cadenya::Internal::Type::BaseModel
      ...
      class Data < Cadenya::Internal::Type::BaseModel
        ...
        sig { returns(Cadenya::UnwrapWebhookEvent::Data::ObjectiveEvent) }
        attr_reader :objective_event

        sig do
          params(
            objective_event:
              Cadenya::UnwrapWebhookEvent::Data::ObjectiveEvent::OrHash
          ).void
        end
          ...
          override.returns(
            {
              ...
              objective_event: Cadenya::UnwrapWebhookEvent::Data::ObjectiveEvent
            }
          )
        end
        def to_hash
