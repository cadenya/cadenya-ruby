...
module Cadenya
  module Models
    class WorkspaceAdminCreateParams < Cadenya::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Cadenya::WorkspaceAdminCreateParams, Cadenya::Internal::AnyHash)
        end

      # CreateAccountResourceMetadata contains the user-provided fields for creating an
      # account-scoped resource. Read-only fields (id, account_id, profile_id) are
      # excluded since they are set by the server.
      sig { returns(Cadenya::WorkspaceAdminCreateParams::Metadata) }
      ...
      sig do
        override.returns(
          {
            metadata: Cadenya::WorkspaceAdminCreateParams::Metadata,
      ...
      class Metadata < Cadenya::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cadenya::WorkspaceAdminCreateParams::Metadata,
