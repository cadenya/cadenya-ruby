      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Cadenya::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Cadenya::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Cadenya::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
