...
module Cadenya
  module Types
    ...
    class ObjectiveEventData_Heartbeat
      attr_reader :type, :heartbeat

      def initialize(type: nil, heartbeat: nil)
        @type = type
        @heartbeat = heartbeat
      end
      ...
      def self.from_json(data)
        new(
          type: data["type"],
          heartbeat: data["heartbeat"].nil? ? nil : Types::ObjectiveHeartbeat.from_json(data["heartbeat"]),
        )
      end
      ...
      def to_h
        {
          type: Util.plain(@type),
          heartbeat: Util.plain(@heartbeat),
        }.reject { |_k, v| v.nil? }
      end
    end
