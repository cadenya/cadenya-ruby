      ...
      class BaseClient
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Cadenya::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Cadenya::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Cadenya::Internal::Util.uri_origin(url) != Cadenya::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Cadenya::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Cadenya::Errors::APIConnectionError | (500..)
              Cadenya::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Cadenya::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Cadenya::Internal::Transport::PooledNetRequester.new
          @headers = Cadenya::Internal::Util.normalized_headers(
          ...
          @base_url_components = Cadenya::Internal::Util.parse_uri(base_url)
          @base_url = Cadenya::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{Cadenya::VERSION}"
        ...
        #
        #   @option req [Class<Cadenya::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Cadenya::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Cadenya::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Cadenya::Internal::Util.interpolate_path(uninterpolated_path)

          query = Cadenya::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = Cadenya::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          headers = Cadenya::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Cadenya::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in Cadenya::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              Cadenya::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise Cadenya::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | Cadenya::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Cadenya::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<Cadenya::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Cadenya::Internal::Type::BaseStream>, nil]
        #
        # @param model [Cadenya::Internal::Type::Converter, Class, nil]
        #
        # @param options [Cadenya::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Cadenya::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Cadenya::RequestOptions.validate!(opts)
          ...
          headers = Cadenya::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = Cadenya::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            Cadenya::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
