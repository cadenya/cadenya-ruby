...
module Cadenya
  module Models
    # @see Cadenya::Resources::WorkspaceSecrets#update
    class WorkspaceSecretUpdateParams < Cadenya::Internal::Type::BaseModel
      ...
      # @!attribute spec
      #
      #   @return [Cadenya::Models::WorkspaceSecretSpec, nil]
      optional :spec, -> { Cadenya::WorkspaceSecretSpec }
