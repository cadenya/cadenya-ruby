...
module Cadenya
  module Models
    class ObjectiveEventWebhookData < Cadenya::Internal::Type::BaseModel
      ...
      #   objective, and event.
      #
      #   @return [Cadenya::Models::ObjectiveEventWebhookData::Data]
      required :data, -> { Cadenya::ObjectiveEventWebhookData::Data }
      ...
      #   {Cadenya::Models::ObjectiveEventWebhookData} for more details.
      #
      #   The envelope for an objective event webhook delivery. Contains timestamp, event
      #   type, and the webhook data payload.
      #
      #   @param data [Cadenya::Models::ObjectiveEventWebhookData::Data] The webhook data payload with flat top-level keys for agent, variation, objectiv
      #
      #   @param timestamp [Time]
      #
      #   @param type [String] The event type, prefixed with objective_event. (e.g., objective_event.tool_resul

      # @see Cadenya::Models::ObjectiveEventWebhookData#data
      class Data < Cadenya::Internal::Type::BaseModel
        ...
        #
        #   @return [Cadenya::Models::ObjectiveEventWebhookData::Data::ObjectiveEvent]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Cadenya::Models::ObjectiveEventWebhookData::Data} for more details.
        #
        #   The webhook data payload with flat top-level keys for agent, variation,
        #   objective, and event.
        #
        ...
        #
        #   @param objective_event [Cadenya::Models::ObjectiveEventWebhookData::Data::ObjectiveEvent]
