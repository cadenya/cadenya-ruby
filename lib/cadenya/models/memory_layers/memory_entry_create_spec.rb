  ...
  module Models
    module MemoryLayers
      class MemoryEntryCreateSpec < Cadenya::Internal::Type::BaseModel
        ...
        # @!method initialize(key:, content: nil, description: nil, type: nil, upload_id: nil)
        ...
        #
        #   @param type [String] The JSON name of the variant set in `source` (e.g. "content"). Required
        #
