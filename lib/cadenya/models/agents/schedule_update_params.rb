...
module Cadenya
  module Models
    module Agents
      # @see Cadenya::Resources::Agents::Schedules#update
      class ScheduleUpdateParams < Cadenya::Internal::Type::BaseModel
        ...
        #
        #   @return [Cadenya::Models::Agents::AgentScheduleSpec, nil]
        optional :spec, -> { Cadenya::Agents::AgentScheduleSpec }
