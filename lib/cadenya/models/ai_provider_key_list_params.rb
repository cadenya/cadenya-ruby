...
module Cadenya
  module Models
    ...
    class AIProviderKeyListParams < Cadenya::Internal::Type::BaseModel
      ...
      # @!method initialize(workspace_id: nil, cursor: nil, include_info: nil, labels: nil, limit: nil, prefix: nil, promotional: nil, query: nil, sort_order: nil, request_options: {})
