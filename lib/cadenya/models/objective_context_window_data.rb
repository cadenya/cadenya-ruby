...
module Cadenya
  module Models
    class ObjectiveContextWindowData < Cadenya::Internal::Type::BaseModel
      ...
      #
      #   @return [String]
      required :previous_window_continue_instructions, String, api_name: :previousWindowContinueInstructions
      ...
      response_only do
        ...
        #
        #   @return [Integer]
        required :completion_tokens, Integer, api_name: :completionTokens
        ...
        #
        #   @return [Integer]
        required :prompt_tokens, Integer, api_name: :promptTokens
      ...
      # @!method initialize(completion_tokens:, objective_id:, previous_window_continue_instructions:, prompt_tokens:, sequence:)
