...
module Cadenya
  module Models
    class ToolSetAdapterOpenAPIURL < Cadenya::Internal::Type::BaseModel
      # @!attribute type
      #
      #   @return [Symbol, Cadenya::Models::ToolSetAdapterOpenAPIURL::Type]
      required :type, enum: -> { Cadenya::ToolSetAdapterOpenAPIURL::Type }
      ...
      # @!method initialize(type:, url:, base_url: nil, exclude_tools: nil, headers: nil, include_tools: nil, server_name: nil, tool_approvals: nil)
      #   Some parameter documentations has been truncated, see
      #   {Cadenya::Models::ToolSetAdapterOpenAPIURL} for more details.
      #
      #   @param type [Symbol, Cadenya::Models::ToolSetAdapterOpenAPIURL::Type]
      #
      ...
      # @see Cadenya::Models::ToolSetAdapterOpenAPIURL#type
      module Type
